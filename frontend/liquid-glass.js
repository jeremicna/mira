    ...
    createElement() {
      ...
      this.container.style.cssText = `
        ...
        box-shadow: 
            ...
            /* 2. Soft inner dark shadow for overall depth */
            inset 0 -10px 25px rgba(0, 0, 0, 0.15),
            /* 3. Bottom-center highlight (shine) */
            inset 0 -3px 8px rgba(255, 255, 255, 0.7),
            /* 4. Bottom and Right edge soft highlights */
            inset 0 -1.5px 3px rgba(255, 255, 255, 0.4), /* Bottom edge light */
            inset -1.5px 0 3px rgba(255, 255, 255, 0.4), /* Right edge light */
            /* 5. Top and Left subtle dark shadows (contrast) */
            inset 1.5px 0 3px rgba(0, 0, 0, 0.1), /* Left edge subtle dark */
            inset 0 1.5px 3px rgba(0, 0, 0, 0.1); /* Top edge subtle dark */
        cursor: grab;
        backdrop-filter: url(#${this.id}_filter) blur(4px) contrast(1.0) brightness(1.05) saturate(1.1);
        z-index: 9999;
        pointer-events: auto;
      `;
  ...
  function createLiquidGlass() {
    ...
    const shader = new Shader({
      ...
      fragment: (uv, mouse) => {
        ...
        const displacement = smoothStep(0.4, 0, distanceToEdge - 0.16);
