...
(function () {
  ...
  class Shader {
    ...
    createElement() {
      // ⚠️ Use existing element instead of creating a new one
      this.container = document.getElementById("glasselement");

      if (!this.container) {
        throw new Error("Element #glasselement not found.");
      }
    ...
    appendTo(parent) {
      ...
      parent.appendChild(this.canvas); // hidden but needed
    }
